...
import com.kluksa.repository.ProjectAllocationRepository;
...
/**
 * REST controller for managing {@link com.kluksa.domain.ProjectAllocation}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProjectAllocationResource {
    ...
    private static final String ENTITY_NAME = "projectManagerProjectAllocation";
