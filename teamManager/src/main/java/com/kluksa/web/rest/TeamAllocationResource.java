...
import com.kluksa.repository.TeamAllocationRepository;
...
/**
 * REST controller for managing {@link com.kluksa.domain.TeamAllocation}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TeamAllocationResource {
    ...
    private static final String ENTITY_NAME = "teamManagerTeamAllocation";
